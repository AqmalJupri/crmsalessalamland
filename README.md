...
| Release | The current production-artifact candidate passes local lint, TypeScript, diff hygiene, dependency audit, both CRM/Tasha Next production builds, **213 release/CI contract tests across 8 files**, capture-mode unit/component coverage with **1,110 pass and 1 intentional provenance skip across 82 files**, all-production-source coverage with **1,367/1,367 pass across 76 files**, and PostgreSQL integration with **601/601 pass across 15 files**. Coverage is 92.27% statements, 85.98% branches, 95.23% functions and 93.32% lines for the high-confidence scope, and 82.63%, 78.05%, 90.46% and 83.94% for all production source. The exact Node `22.23.1` OCI image/SBOM/scan/restricted-runtime path has not yet completed hosted CI; no registry promotion or production deployment exists, and every acceptance gate remains **Not passed**. |
...
- Runtime contract: exact hosted/build Node.js `22.23.1` with package compatibility `>=22.22.0 <23`, pnpm `11.9.0`, Next.js `16.2.10`, React `19.2.7`, and TypeScript `6.0.3`. Release images use a separately digest-locked Distroless Node 22 Debian 13 non-root runtime and must prove exact base ancestry.
- Every GitHub Actions job is pinned to `ubuntu-24.04`, asserts x64 before using Linux/amd64 locks, and permits only the reviewed exact action repositories and commit SHAs. Core pins include checkout `34e114876b0b11c390a56381ad16ebd13914f8d5`, pnpm setup `b906affcce14559ad1aafd4ab0e942779e9f58b1`, Node setup `49933ea5288caeca8642d1e84afbd3f7d6820020`, artifact upload/download and trusted-main-only attestation.
...
- The reviewed migration ledger is `0001_foundation.sql` (`169f78b45d72a1119969defafee5c2ab6934bb21682ebc53e90850e7651ea0de`), `0002_migration_platform.sql` (`2e8425ae8f551fc5b8c96466f36e917df118a12a18c66e69ec68800e73ec0e73`), `0003_reconciliation_bytewise_order.sql` (`46fb6ab301eb4362dc4c74c186a432e59bcf00736e78ab3d5d8ea8e7359885c4`), `0004_membership_user_identity_guard.sql` (`58713ceda7660aa4a5385c734744c9bb9e12ccb00272032acf9a34cdfca70c5c`), `0005_reconciliation_typed_result_truth.sql` (`8fbf0ff4b506cc682b16b6d3fe4b59d69ee47040b95ed20542ff6983c496c381`), `0006_reconciliation_finite_amounts.sql` (`c320a95155c63273f176d2d79df7f9c729285b9c0474e332207da8f4bf0c5541`), and `0007_reconciliation_signoff_lifecycle.sql` (`377718a38cd3af63d0e2eeceecdb2c979fa912714b6d5fc131a79a687a20a6de`). The manifest also locks their exact byte lengths and rejects missing, extra, reordered, or modified migration files.
