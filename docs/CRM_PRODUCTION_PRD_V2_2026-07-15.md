...
|---|---|---|
| Lint and TypeScript | PASS on integrated Round 1 | Local shell currently uses Node 22.22.3; hosted forced-fresh capture run `29657949035` and standard reviewed-baseline run `29658551712` exercised exact application Node 22.22.0 and finished every job successfully; a clean rerun is pending after one retry-only browser-test hydration correction |
| High-confidence coverage | Normal reviewed-evidence mode: 76 files, 936/936 pass. Explicit capture mode: 76 files, 935 pass and one provenance assertion skipped. Both report 92.27% statements, 85.98% branches, 95.23% functions, 93.32% lines | The skip is restricted to generating a new candidate; reviewed normal mode verifies the promoted 60-asset provenance |
| All-production-source coverage | 76 files, 1,367/1,367 pass; 82.63% statements, 78.07% branches, 90.46% functions, 83.94% lines | Coverage is engineering evidence, not UAT, capacity, penetration, privacy or production approval |
...
| Reviewed visual evidence | Hosted capture: CRM 35 pass/14 skip and Tasha 25 pass/10 skip; 60 synthetic Linux PNGs in artifact `8433505065`, digest `sha256:6d53cd71311ae912ac32041ef2e6c9fa496a308eb5fb8b3b2e0aa251d0dc2de9`; all 60 assets/provenance reviewed and promoted byte-identically in `9f2c8cd` | Standard comparison passed the assets but included one unrelated retry-only E2E setup race; named human screen-reader journey sign-off and a zero-flaky rerun remain open; visual review is not accessibility or UAT approval |
...
Reproducibility is authored around Node.js `22.22.0`, pnpm `11.9.0`, Next.js `16.2.10`, React `19.2.7`, TypeScript `6.0.3`; commit-pinned checkout `34e114876b0b11c390a56381ad16ebd13914f8d5`, pnpm setup `b906affcce14559ad1aafd4ab0e942779e9f58b1`, and Node setup `49933ea5288caeca8642d1e84afbd3f7d6820020`; and PostgreSQL image `postgres:16.14-alpine@sha256:57c72fd2a128e416c7fcc499958864df5301e940bca0a56f58fddf30ffc07777`. Forced-fresh hosted run `29657949035` is fully green and produced the reviewed Linux evidence promoted in `9f2c8cd`; standard run `29658551712` compared those assets successfully but reported one retry-only pre-hydration mutation in a non-visual test. The deterministic test correction awaits a zero-flaky hosted rerun. No signed immutable registry image, trusted promotion, staging/production deployment or production release exists. Earlier runs failed closed as designed on stale or rejected visual evidence rather than accepting it to make CI green.
